...
SOURCE_DATA_PATH = "dataproc/hive/part-00000.parquet"
...
INSERT INTO TABLE {TABLE_NAME} PARTITION (TransactionType)
...
with models.DAG(
    ...
    def get_hive_warehouse_bucket(**kwargs):
        ...
        ti = kwargs["ti"]
        metastore_service: dict = ti.xcom_pull(task_ids="create_cluster")
