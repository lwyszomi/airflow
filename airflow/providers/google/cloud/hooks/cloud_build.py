...
class CloudBuildAsyncHook(GoogleBaseHook):
    ...
    sync_hook_class = CloudBuildHook

    def get_cloud_build_client(self) -> CloudBuildAsyncClient:
        """Instantiates the Cloud Build async client."""
        return CloudBuildAsyncClient(
    ...
    async def get_cloud_build(
        ...
        client = self.get_cloud_build_client()
        ...
        if type(build_instance) != Build:
            raise AirflowException("Incorrect Cloud Build instance received")
