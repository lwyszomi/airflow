...
from airflow.providers.google.cloud.hooks.kubernetes_engine import GKEHook, GKEJobHook, GKEPodHook
...
class GKEClusterAuthDetails:
    """
    Hellper for fetching information about cluster for connecting.
